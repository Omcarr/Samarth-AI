  ...
  return (
    ...
    >
      ...
      <div className="md:w-full flex justify-center align-center">
        ...
        <div
          className={` flex md:w-[90%] w-full flex-col min-h-screen  ${
            ...
            {messages.length === 0 && (
              ...
              >
                <div className="w-full max-w-4xl p-6 flex flex-col md:flex-row">
                  ...
                  <div
                    ref={leftSectionRef}
                    className="md:w-full text-center md:text-left md:pr-8 border-b md:border-b-0 md:border-r border-gray-300 pb-6 md:pb-0"
                  >
                    <h2
...
<ReactMarkdown>{message.content}</ReactMarkdown>
      ...
      {/* {message.role === 'assistant' && message.responseTime !== undefined && (
        <div className="text-xs text-gray-500 mt-1">
          Generated in {message.responseTime.toFixed(2)} seconds
        </div>
      )} */}
