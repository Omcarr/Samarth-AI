...
const ProjectPersonalQuestion = () => {
  const {theme , toggleTheme} = useTheme();
  const [mode, setMode] = useState('Personal_query'); // 'generic', 'document_processing', 'personal_query'
            ...
            >
              ...
              <div className="flex items-center space-x-2">
                ...
                <input
                  ...
                  className={`flex-grow p-4 border border-[#D9D9D9] rounded-full focus:outline-none focus:ring-2 ${
                    theme === "dark"
...
export default ProjectPersonalQuestion;
